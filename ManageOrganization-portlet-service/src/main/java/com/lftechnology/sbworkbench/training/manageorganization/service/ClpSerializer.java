...
import com.lftechnology.sbworkbench.training.manageorganization.model.departmentClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "manageOrganization-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "manageOrganization-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.lftechnology.sbworkbench.training.manageorganization.model.impl.departmentImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "com.lftechnology.sbworkbench.training.manageorganization.NoSuchdepartmentException")) {
            return new com.lftechnology.sbworkbench.training.manageorganization.NoSuchdepartmentException();
        }
